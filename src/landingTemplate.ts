...
export default function landingTemplate(manifest: Manifest): string {
    ...
    const subtitlePairs = [
        { l1: 'May the Force be with you', l2: 'Que la fuerza te acompañe', anim: 'floatUp1', dur: '35s', delay: '0s', left: '2%' },
        { l1: "I'll be back", l2: '我还会回来的', anim: 'floatUp2', dur: '32s', delay: '2s', left: '15%' },
        { l1: 'To infinity and beyond', l2: 'हमेशा के लिए और उससे आगे', anim: 'floatUp3', dur: '40s', delay: '4s', left: '28%' },
        { l1: 'Why so serious?', l2: 'لماذا هذا الجد؟', anim: 'floatUp4', dur: '38s', delay: '6s', left: '42%' },
        { l1: 'Hasta la vista, baby', l2: 'Até logo, baby', anim: 'floatUp5', dur: '36s', delay: '8s', left: '55%' },
        { l1: 'I see dead people', l2: 'Я вижу мёртвых людей', anim: 'floatUp6', dur: '42s', delay: '10s', left: '68%' },
        { l1: 'You talkin\' to me?', l2: '俺に話しかけてるのか？', anim: 'floatUp7', dur: '30s', delay: '12s', left: '81%' },
        { l1: "There's no place like home", l2: 'Kein Ort wie zu Hause', anim: 'floatUp8', dur: '45s', delay: '14s', left: '94%' },
        { l1: 'Just keep swimming', l2: '그냥 계속 헤엄쳐', anim: 'floatUp9', dur: '33s', delay: '16s', left: '7%' },
        { l1: 'I am your father', l2: 'Sono tuo padre', anim: 'floatUp10', dur: '37s', delay: '18s', left: '20%' },
        { l1: 'You shall not pass', l2: 'Geçemeyeceksin', anim: 'floatUp11', dur: '41s', delay: '20s', left: '33%' },
        { l1: 'Here\'s looking at you, kid', l2: 'ดูที่เธอสิ เด็กน้อย', anim: 'floatUp12', dur: '39s', delay: '22s', left: '47%' },
        { l1: 'Life is like a box of chocolates', l2: 'La vie est comme une boîte de chocolats', anim: 'floatUp1', dur: '36s', delay: '24s', left: '60%' },
        { l1: 'ET phone home', l2: 'Mammad evə zəng edir', anim: 'floatUp2', dur: '34s', delay: '26s', left: '73%' },
        { l1: 'After all, tomorrow is another day', l2: 'سواء كان غداً يوم اخر', anim: 'floatUp3', dur: '44s', delay: '28s', left: '86%' },
        { l1: 'Show me the money', l2: 'Pokaż mi pieniądze', anim: 'floatUp4', dur: '31s', delay: '30s', left: '10%' },
        { l1: 'You can\'t handle the truth', l2: 'سzt 자네는 진실을 감당 못 해', anim: 'floatUp5', dur: '35s', delay: '32s', left: '23%' },
        { l1: 'I\'ll have what she\'s having', l2: 'أريد ما طلبته هي', anim: 'floatUp6', dur: '38s', delay: '34s', left: '36%' },
        { l1: 'Houston, we have a problem', l2: 'Xyustonda muammo bor', anim: 'floatUp7', dur: '32s', delay: '1s', left: '50%' },
        { l1: 'E.T. phone home', l2: 'E.T. gọi về nhà', anim: 'floatUp8', dur: '42s', delay: '3s', left: '63%' },
        { l1: 'My precious', l2: '我的宝贝', anim: 'floatUp9', dur: '28s', delay: '5s', left: '76%' },
        { l1: 'Freedom!', l2: 'آزادی!', anim: 'floatUp10', dur: '30s', delay: '7s', left: '89%' },
        { l1: 'Open the pod bay doors', l2: 'Öffne die Pod-Bay-Türen', anim: 'floatUp11', dur: '38s', delay: '9s', left: '4%' },
        { l1: 'I feel the need for speed', l2: 'Siento la necesidad de velocidad', anim: 'floatUp12', dur: '33s', delay: '11s', left: '17%' },
        { l1: 'Go ahead, make my day', l2: 'Avanti, mi faccia il piacere', anim: 'floatUp1', dur: '40s', delay: '13s', left: '30%' },
        { l1: 'I\'m king of the world!', l2: 'मैं दुनिया का बादशाह हूँ!', anim: 'floatUp2', dur: '36s', delay: '15s', left: '43%' },
        { l1: 'Nobody puts Baby in a corner', l2: 'Ninguém põe a Baby num canto', anim: 'floatUp3', dur: '42s', delay: '17s', left: '57%' },
        { l1: 'They may take our lives', l2: 'Вони можуть забрати наші життя', anim: 'floatUp4', dur: '28s', delay: '19s', left: '70%' },
        { l1: 'Do or do not, there is no try', l2: 'やってやるか、やらないかだ', anim: 'floatUp5', dur: '46s', delay: '21s', left: '83%' },
        { l1: 'Say hello to my little friend', l2: 'Diga olá ao meu pequeno amigo', anim: 'floatUp6', dur: '34s', delay: '23s', left: '96%' },
        { l1: 'I\'m walking here!', l2: '여기 걷고 있단 말이야!', anim: 'floatUp7', dur: '31s', delay: '25s', left: '12%' },
        { l1: 'Every passing minute is another chance', l2: 'Her geçen dakika başka bir şans', anim: 'floatUp8', dur: '43s', delay: '27s', left: '25%' },
        { l1: 'The first rule is you do not talk', l2: 'La première règle est de ne pas en parler', anim: 'floatUp9', dur: '37s', delay: '29s', left: '38%' },
        { l1: 'It\'s alive!', l2: 'انه حي!', anim: 'floatUp10', dur: '30s', delay: '31s', left: '52%' },
        { l1: 'Here\'s Johnny!', l2: 'Hier ist Johnny!', anim: 'floatUp11', dur: '35s', delay: '33s', left: '65%' },
        { l1: 'Bond, James Bond', l2: '叫我詹姆斯·邦德', anim: 'floatUp12', dur: '32s', delay: '35s', left: '78%' },
        { l1: 'Life moves pretty fast', l2: 'La vie passe assez vite', anim: 'floatUp1', dur: '39s', delay: '37s', left: '91%' },
        { l1: 'Snakes, why did it have to be snakes', l2: 'Змеи, зачем именно змеи', anim: 'floatUp2', dur: '41s', delay: '39s', left: '8%' },
        { l1: 'Play it again, Sam', l2: 'Toccalo ancora, Sam', anim: 'floatUp3', dur: '35s', delay: '41s', left: '21%' },
        { l1: 'As you wish', l2: 'جされしままに', anim: 'floatUp4', dur: '29s', delay: '43s', left: '34%' },
    ];
